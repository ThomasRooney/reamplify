...
export class VerifySesEmailAddress extends Construct {
  constructor(parent: Construct, name: string, props: IVerifySesEmailAddressProps) {
    ...
    new cdk.custom_resources.AwsCustomResource(this, `VerifyEmailIdentity` + emailAddress, {
      onCreate: {
        service: `SES`,
        ...
        physicalResourceId: cdk.custom_resources.PhysicalResourceId.of(`verify-` + emailAddress),
        region,
      },
      onDelete: {
        service: `SES`,
